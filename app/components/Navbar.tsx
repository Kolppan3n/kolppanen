...
export default function Navbar(){
    ...
    return (
        <nav className={'lg:flex justify-center items-center p-4 bg-gradient-to-t from-transparent via-background-dark to-background-dark'}>
            <h1 className='text-center text-3xl mx-4'>KOLPPANEN.COM</h1>
            <div className='text-xl text-stone-dark'>|</div>
